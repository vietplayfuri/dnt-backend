namespace costs.net.integration.tests.Plugins.PG.PaymentRules
{
    ...
    public class PaymentRule_Japan_nonAIPE_J : PaymentRuleIntegrationTestBase
    {
        // rule name - "Japan-NonAIPE-NonDPV-J"
        [Test]
        public async Task PaymentRule_Japan_J_OE_stage()
        {
            // Arrange
            InitData(
                isAipe: false,
                stageKey: CostStages.OriginalEstimate.ToString(),
                budgetRegion: Constants.BudgetRegion.Japan,
        ...
        [Test]
        public async Task PaymentRule_Japan_J_FA_stage_with_previous_payments()
        {
            // Arrange
            InitData(
                isAipe: false,
        ...
        [Test]
        public async Task PaymentRule_Japan_J_FA_stage_with_previous_payments_with_overpayment()
        {
            // Arrange
            InitData(
                isAipe: false,
