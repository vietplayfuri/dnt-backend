...
delete from cost_line_item where id in ('1e23e165-6648-4bf3-a9df-74c7eb6686ca','2115b88b-7a9b-4005-afb2-2f77efbf3192','f98f497e-049c-44a3-945a-6e59b61153ae','80eb635b-8a00-49e8-a1e1-29815296e2f4','39f632f9-4690-4e0f-80b2-7146294311e1','18dc6b76-a110-4794-b0fb-7189989eabd7','a0d543d6-ad41-4d9f-83ba-5676f7bf47a8','13d199a4-8fd8-4403-8547-4dddd84b3213','61e9c4b6-a483-4096-9ca8-266486a144a9','b311d99d-d6b8-4234-9634-8c37d418aa6d','f63c9a2d-d085-4646-9af9-b652c9c8b681','6fec56c3-f234-4b21-afda-68943c2ce613','ea5d2510-2cc7-4cd1-b2aa-86f12798cced');



update custom_object_data
set
    data = '{"isAIPE": false, "costType": "Production", "otherCost": 0.0, "totalCost": 9485.0, "costStages": "OriginalEstimate", "contentType": "Video", "stageTotals": {"otherCostTotal": 0.0, "targetBudgetTotal": 0.0, "insuranceCostTotal": 0.0, "talentFeeCostTotal": 0.0, "productionCostTotal": 0.0, "totalCostAmountTotal": 9485.0, "technicalFeeCostTotal": 0.0, "postProductionCostTotal": 9485.0}, "budgetRegion": "LATIN AMERICA AREA", "insuranceCost": 0.0, "talentFeeCost": 0.0, "productionCost": 0.0, "productionType": "Post Production Only", "totalCostAmount": 9485.0, "technicalFeeCost": 0.0, "postProductionCost": 9485.0, "costCarryOverAmount": 0.0, "directPaymentVendorId": "55170e28-119e-11e8-9527-0a5d70ceb10e", "targetBudgetTotalCost": 0.0}'
where
    object_id = '702b8414-d9db-47c4-b9a4-c06c3d85e997' and name = 'PaymentRuleInput';

update cost_stage_revision_payment_total
set
    line_item_full_cost = 9485,
    line_item_remaining_cost = 0,
    line_item_total_calculated_value = 0.0
where
    cost_stage_revision_id = '702b8414-d9db-47c4-b9a4-c06c3d85e997'
    and line_item_total_type = 'CostTotal'
    and stage_name = 'OriginalEstimate';
...
set
    line_item_full_cost = 9485,
    line_item_remaining_cost = 0,
    line_item_total_calculated_value = 9485
where
    cost_stage_revision_id = '702b8414-d9db-47c4-b9a4-c06c3d85e997'
    and line_item_total_type = 'CostTotal'
    and stage_name = 'FinalActual';
...
delete from cost_line_item where id in ('8352eecd-7566-4f5d-aea5-3e7d9caf9b34','8fc5bfd7-a1d4-4180-bdb9-50e3e8a935f9','f04f76a0-9814-4722-bf35-6000cdb46f0a','475768e2-37c1-4efc-9a63-e5542ccc3bf9','30a874d5-0931-410b-a285-a6e454d6cb7f','9eb44706-5779-4bb4-8832-0b5738354caf','d69cf954-7ba0-41ad-b4cb-580bd52ec9da','84a6afc2-8145-42e0-a204-2cb7d038a0a7','cb173e9a-fca5-4e3c-b4fb-99134aebc9f5','61f347c1-39f8-40df-ae22-e33448ea1649','5c850b50-6bf2-415f-8231-eb54e2efccc4','54aa48fc-3140-40f5-91df-34a4275a0e9d','63e80f1f-2044-4076-851b-f04c5daee0cd');

update custom_object_data
set
    data = '{"isAIPE": false, "costType": "Production", "otherCost": 0.0, "totalCost": 28455.0, "costStages": "OriginalEstimate", "contentType": "Video", "stageTotals": {"otherCostTotal": 0.0, "targetBudgetTotal": 0.0, "insuranceCostTotal": 0.0, "talentFeeCostTotal": 0.0, "productionCostTotal": 0.0, "totalCostAmountTotal": 28455.0, "technicalFeeCostTotal": 0.0, "postProductionCostTotal": 28455.0}, "budgetRegion": "LATIN AMERICA AREA", "insuranceCost": 0.0, "talentFeeCost": 0.0, "productionCost": 0.0, "productionType": "Post Production Only", "totalCostAmount": 28455.0, "technicalFeeCost": 0.0, "postProductionCost": 28455.0, "costCarryOverAmount": 0.0, "directPaymentVendorId": "55170e28-119e-11e8-9527-0a5d70ceb10e", "targetBudgetTotalCost": 0.0}'
where
    object_id = 'a0475197-1edc-4e33-a23b-7e86c9891a2f' and name = 'PaymentRuleInput';
   
update cost_stage_revision_payment_total
set
    line_item_full_cost = 28455.0,
    line_item_remaining_cost = 0,
    line_item_total_calculated_value = 0.0
where
    cost_stage_revision_id = 'a0475197-1edc-4e33-a23b-7e86c9891a2f'
    and line_item_total_type = 'CostTotal'
    and stage_name = 'OriginalEstimate';
...
set
    line_item_full_cost = 28455.0,
    line_item_remaining_cost = 0,
    line_item_total_calculated_value = 28455.0
where
    cost_stage_revision_id = 'a0475197-1edc-4e33-a23b-7e86c9891a2f'
    and line_item_total_type = 'CostTotal'
    and stage_name = 'FinalActual';
...
begin	
   	FOR c_number IN 
   		select distinct c.cost_number		
		from cost c
		join cost_stage cs on c.id = cs.cost_id
		join cost_stage_revision csr on cs.id = csr.cost_stage_id
		where 
		csr.id in (
		select cost_stage_revision_id from ( 
		select cost_stage_revision_id, "name" from cost_line_item
		group by cost_stage_revision_id, "name"
		having count(cost_stage_revision_id) > 1 and count("name") > 1) as d1)
   	LOOP
   		RAISE NOTICE 'Start with Cost#: %', c_number;		
		FOR csr_id IN select distinct csr.id
			   		from cost c
					join cost_stage cs on c.id = cs.cost_id
					join cost_stage_revision csr on cs.id = csr.cost_stage_id 
					where c.cost_number = c_number
	   	LOOP
			RAISE NOTICE 'Revision has duplicated cost line items: %', csr_id;
			FOR cli_name IN select distinct "name" 
					   		from cost_line_item
							where cost_stage_revision_id = csr_id							
							group by "name"
							having count("name") > 1
			LOOP		   		
		   		FOR duplicated_cli IN select id from (
			   						select ROW_NUMBER () OVER (ORDER BY name), * 
			   						from cost_line_item
									where cost_stage_revision_id = csr_id
									and "name" = cli_name) as d2
									where row_number > 1
				LOOP
					delete from cost_line_item where id = duplicated_cli;				   
				END LOOP;			
		   	END LOOP;
	    RAISE NOTICE 'Finish revision: %', csr_id;
	   	END LOOP;
	    RAISE NOTICE 'Finish COST: %', c_number;
   	END LOOP;
END
$do$;
...
ALTER TABLE cost_line_item DROP CONSTRAINT IF EXISTS cost_line_item_uq_csrid_name;
ALTER TABLE cost_line_item ADD CONSTRAINT cost_line_item_uq_csrid_name UNIQUE (cost_stage_revision_id, "name");