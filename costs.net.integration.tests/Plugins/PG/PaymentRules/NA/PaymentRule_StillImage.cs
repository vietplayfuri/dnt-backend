namespace costs.net.integration.tests.Plugins.PG.PaymentRules.NA
{
    ...
    // ADC-2237
    public class PaymentRule_StillImage : PaymentRuleIntegrationTestBase
    {
        public class TestCase
        {
            public static string BudgetRegion => Constants.BudgetRegion.NorthAmerica;
            public static string ContectType => Constants.ContentType.Photography;
        ...
        private static TestCase[] _fullProduction = {
            ...
            new TestCase
            {
                ...
                // (100 - 200 - 500 - 150) * 1.0 + 700 * 0.5 = 500
            ...
            //    PostProductionCostsAmount = 700,
            //    // Payed
            //    ProductionCostsPayedAmount = 500,
            //    TalentFeesPayedAmount = 500,
            //    InsuranceTotalPayed = 200,
            //    TechFeeAmountPayed = 100,
        ...
        public async Task PaymentRule_Europe_StillImage(TestCase testCase)
        {
            // Arrange
            InitData(
                isAipe: false,
